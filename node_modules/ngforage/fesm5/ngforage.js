...
var NgForageConfig = /** @class */ (function () {
    ...
    /** @nocollapse */ NgForageConfig.ngInjectableDef = ɵɵdefineInjectable({ factory: function NgForageConfig_Factory() { return new NgForageConfig(ɵɵinject(DEFAULT_CONFIG, 8)); }, token: NgForageConfig, providedIn: "root" });
...
var InstanceFactory = /** @class */ (function () {
    ...
    /** @nocollapse */ InstanceFactory.ngInjectableDef = ɵɵdefineInjectable({ factory: function InstanceFactory_Factory() { return new InstanceFactory(ɵɵinject(NgForageConfig)); }, token: InstanceFactory, providedIn: "root" });
...
var NgForage = /** @class */ (function (_super) {
    ...
    /** @nocollapse */ NgForage.ngInjectableDef = ɵɵdefineInjectable({ factory: function NgForage_Factory() { return new NgForage(ɵɵinject(NgForageConfig), ɵɵinject(InstanceFactory)); }, token: NgForage, providedIn: "root" });
    return NgForage;
...
var NgForageCache = /** @class */ (function (_super) {
    ...
    /** @nocollapse */ NgForageCache.ngInjectableDef = ɵɵdefineInjectable({ factory: function NgForageCache_Factory() { return new NgForageCache(ɵɵinject(NgForageConfig), ɵɵinject(InstanceFactory)); }, token: NgForageCache, providedIn: "root" });
...
var DedicatedInstanceFactory = /** @class */ (function () {
    ...
    /** @nocollapse */ DedicatedInstanceFactory.ngInjectableDef = ɵɵdefineInjectable({ factory: function DedicatedInstanceFactory_Factory() { return new DedicatedInstanceFactory(ɵɵinject(NgForageConfig), ɵɵinject(InstanceFactory)); }, token: DedicatedInstanceFactory, providedIn: "root" });
...
export { BaseConfigurableImpl, CachedItemImpl, DEFAULT_CONFIG, DedicatedInstanceFactory, Driver, InstanceFactory, NgForage, NgForageCache, NgForageCacheDedicated, NgForageConfig, NgForageDedicated, NgForageModule };
