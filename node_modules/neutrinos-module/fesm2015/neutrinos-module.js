...
import { Injectable, EventEmitter, Input, Output, HostListener, Directive, ViewChild, Component, Renderer2, NgModule } from '@angular/core';
...
let NFileIOService = class NFileIOService {
    ...
    saveToBrowser(data, fileName) {
        return new Promise((resolve) => {
            // Edge 20+
            const isEdge = !( /*@cc_on!@*/ !!document['documentMode']) && !!window.StyleMedia;
            if (isEdge) {
